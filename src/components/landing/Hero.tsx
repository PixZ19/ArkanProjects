...
const wizardScript: WizardStep[] = [
  ...
  { type: 'output', text: '  [i] Panel terbaru: v1.12.2 | Wings terbaru: v1.12.1', color: '#00ff88', typingDelay: 0, lineDelay: 100 },
  ...
  { type: 'output', text: '  [3/8] Mengunduh file Pterodactyl Panel v1.12.2...', color: '#00ffff', typingDelay: 0, lineDelay: 150 },
  ...
  { type: 'output', text: '  [2/5] Mengunduh Pterodactyl Wings v1.12.1...', color: '#00ffff', typingDelay: 0, lineDelay: 150 },
